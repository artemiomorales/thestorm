...
// Fades in the "fade" div, empties the bounding box, then fades the "fade" div back out
	...
	function creditsMusic() {
		...
		if(audio.paused) {
			 replaceAudio("background", "http://www.muzzine.com/libraryContent/hurricane/love_this_storm");
		}
	}
...
// Object constructor to store all information presented on the slide
	...
	function retrieveXML(location) {
		...
		xmlhttp.open("GET","http://www.muzzine.com/libraryContent/hurricane/"+location+".xml",false);
		xmlhttp.send("");
	...
	function retrieveSlide(number) {
		...
		xmlhttp.open("GET","http://www.muzzine.com/libraryContent/hurricane/slides.xml",false);
		xmlhttp.send();
...
$(document).ready(function(){
	...
	fullscreen.onclick = function() {
		...
		if(document.mozFullScreen || document.webkitIsFullScreen) {
			if (element.mozRequestFullScreen) {document.mozCancelFullScreen();}
	...
	preloadImgs ([
		'http://www.muzzine.com/libraryContent/hurricane/button.gif',
		'http://www.muzzine.com/libraryContent/hurricane/hound_large.png',
		'http://www.muzzine.com/libraryContent/hurricane/hound2_large.png',
		'http://www.muzzine.com/libraryContent/hurricane/treesMenu.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/boatsMenu.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/fashionMenu.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/car0.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/loveStorm.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/stormSong0.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/stormSong1.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/stormSong2.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/treesStorm.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/fashionStorm.jpg',
		'http://www.muzzine.com/libraryContent/hurricane/stormSisters.jpg'
	])
	
	function preloadText() {
		$.ajax({
			type: "GET",
			url: "http://www.muzzine.com/libraryContent/hurricane/text.xml",
			dataType: "xml"
		})
	}
